...
function CreateAccount() {
  ...
  const [inputDetailsShown, setInputDetailsShown] = useState(false)
  ...
  const handleCreateAccountClick = (event) => {
    ...
    if (user && user.error === null) {
      ...
      setInputDetailsShown(true)
      } else {console.error("Account creation failed: "+ user.error)}
  }

  return (
    <div className={styles.container}>
      {/* Account details input */}
      {inputDetailsShown ? <AccountDetailsInput /> :
